// copy from https://github.com/hackmdio/codimd/blob/develop/public/js/lib/editor/table-editor.js
// we have to remove "tableTools" variables, import packages jquery and codemirror
